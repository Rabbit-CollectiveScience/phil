...
void main() {
  group('ShouldShowFilterPageUseCase', () {
    ...
    test('returns true when no previous selection exists', () async {
      when(
        mockRepository.getLastFilterTimestamp(),
    ...
    test(
      'returns true when last selection was more than 2 hours ago',
      () async {
    ...
    test(
      'returns false when last selection was less than 2 hours ago',
      () async {
    ...
    test(
      'returns true when last selection was 2 hours and 1 minute ago',
      () async {
